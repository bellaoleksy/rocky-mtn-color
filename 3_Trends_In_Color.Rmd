...
trend_table<-bind_rows(tab1, tab2)%>%
  ...
  mutate(res=recode(res,
         ...
         Mode_change=recode(Mode_change,
                            'Change to Green/murky'="Blue/clear to Green/murky",
                            'Change to Blue/clear'="Green/murky to Blue/clear"),
...
#### Supp version with top 10 variables

```{r}

png(
  filename = 'figs/RF_results_top10.png',
  width = 8,
  height = 13,
  res = 600,
  units = 'in'
